...
namespace Qml.Net
{
    ...
    internal class QQmlApplicationEngineInterop
    {
        ...
        [NativeSymbol(Entrypoint = "qqmlapplicationengine_registerSingletonInstanceNet")]
        public RegisterSingletonInstanceNetDel RegisterSingletonInstanceNet { get; set; }

        [SuppressUnmanagedCodeSecurity]
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int RegisterSingletonInstanceNetDel(IntPtr type, [MarshalAs(UnmanagedType.LPWStr)]string uri, int versionMajor, int versionMinor, [MarshalAs(UnmanagedType.LPWStr)]string typeName,
            IntPtr instance);
