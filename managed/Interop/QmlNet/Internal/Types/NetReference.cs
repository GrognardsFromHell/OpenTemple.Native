...
namespace Qml.Net.Internal.Types
{
    public class NetReference : BaseDisposable
    {
        ...
        public static NetReference CreateForObject(object value, bool autoCreateIfNotExist = true, bool owned = true)
        {
            ...
            var newNetReference = new NetReference(objectId.Value, typeInfo, owned);
